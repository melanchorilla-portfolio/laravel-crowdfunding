...
Route::get('/get-profile', [\App\Http\Controllers\Api\UserController::class, 'getProfile'])->middleware('auth:api');
...
Route::get('/campaign/get-all', [\App\Http\Controllers\Api\CampaignController::class, 'getAll']);
